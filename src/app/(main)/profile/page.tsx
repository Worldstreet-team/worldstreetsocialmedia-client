	...
	return (
		<div className="flex flex-col min-h-screen">
			<header className="sticky top-0 z-20 bg-white/80 backdrop-blur-md border-b border-border-gray px-4 py-1 flex items-center gap-6">
				<button
					className="rounded-full w-9 h-9 hover:bg-black/10 flex items-center justify-center transition-colors"
					type="button"
				>
			...
			<div className="flex justify-end px-4 py-3 gap-2 mt-2">
				<button
					className="w-9 h-9 border border-border-gray rounded-full flex items-center justify-center hover:bg-black/[0.03] transition-colors"
					type="button"
				>
					<MoreIcon />
				</button>
				...
				<button
					className="border border-border-gray rounded-full px-4 font-bold hover:bg-black/[0.03] transition-colors text-[15px]"
					type="button"
				>
					Edit profile
				</button>
			...
			<div className="px-4 mt-8 flex flex-col gap-3">
				...
				<div className="flex gap-5 text-[15px]">
					...
					<div className="hover:underline cursor-pointer">
						<span className="font-bold text-black">10.4K</span>{" "}
				...
				{activeTab === "posts" ? (
					...
					<div className="p-12 text-center">
						<h2 className="text-2xl font-bold mb-2 break-words">
							@
							{activeTab === "likes"
								? "arivera haven't liked any tweets"
								: `arivera hasn't posted any ${activeTab} yet`}
						</h2>
