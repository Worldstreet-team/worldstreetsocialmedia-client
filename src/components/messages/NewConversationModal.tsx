						...
						<div className="shrink-0 p-4">
							<div className="relative">
								...
								<input
									...
									autoFocus
									className="w-full bg-primary/5 rounded-pill pl-10 pr-4 py-2.5 text-base sm:text-sm text-primary placeholder:text-subtle focus:bg-primary/10 outline-none transition-colors"
								/>
							</div>
