...
export function TypingIndicator({
	...
	return (
		<div className="flex flex-col items-start">
			<div className="flex items-center gap-1 px-3.5 py-[13px]" style={{ background: "var(--chat-theirs, var(--ws-bg-raised))", borderRadius: "var(--chat-r, 22px) var(--chat-r, 22px) var(--chat-r, 22px) var(--chat-r-in, 8px)" }}>
				{mode === "recording" && (
