...
export function SidebarWallet() {
	...
	return (
		// The card only exists once the balance lands, so it rises in rather
		// than snapping. A wrapper, because framer's inline opacity would
		// otherwise pin the anchor's own hover fade.
		<motion.div {...reveal()}>
			<a
